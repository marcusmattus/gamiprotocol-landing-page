...
var require_dayjs_min = __commonJS({
  "node_modules/dayjs/dayjs.min.js"(exports, module) {
    !function(t2, e2) {
      ...
      "use strict";
      var t2 = 1e3, e2 = 6e4, n3 = 36e5, r2 = "millisecond", i3 = "second", s2 = "minute", u3 = "hour", a2 = "day", o2 = "week", c3 = "month", f7 = "quarter", h4 = "year", d2 = "date", l4 = "Invalid Date", $2 = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, y5 = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, M3 = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(t3) {
        ...
        var r3 = 12 * (n4.year() - e3.year()) + (n4.month() - e3.month()), i4 = e3.clone().add(r3, c3), s3 = n4 - i4 < 0, u4 = e3.clone().add(r3 + (s3 ? -1 : 1), c3);
        return +(-(r3 + (n4 - i4) / (s3 ? i4 - u4 : u4 - i4)) || 0);
      }, a: function(t3) {
        return t3 < 0 ? Math.ceil(t3) || 0 : Math.floor(t3);
      }, p: function(t3) {
        return { M: c3, y: h4, w: o2, d: a2, D: d2, h: u3, m: s2, s: i3, ms: r2, Q: f7 }[t3] || String(t3 || "").toLowerCase().replace(/s$/, "");
      }, u: function(t3) {
        return void 0 === t3;
      } }, g = "en", D = {};
      D[g] = M3;
      ...
      var _ = function() {
        ...
        return m3.parse = function(t3) {
          ...
          var n4 = this, r3 = !!b2.u(e3) || e3, f8 = b2.p(t3), l5 = function(t4, e4) {
          ...
          }, y6 = this.$W, M5 = this.$M, m4 = this.$D, v4 = "set" + (this.$u ? "UTC" : "");
          switch (f8) {
            case h4:
          ...
          var n4, o3 = b2.p(t3), f8 = "set" + (this.$u ? "UTC" : ""), l5 = (n4 = {}, n4[a2] = f8 + "Date", n4[d2] = f8 + "Date", n4[c3] = f8 + "Month", n4[h4] = f8 + "FullYear", n4[u3] = f8 + "Hours", n4[s2] = f8 + "Minutes", n4[i3] = f8 + "Seconds", n4[r2] = f8 + "Milliseconds", n4)[o3], $3 = o3 === a2 ? this.$D + (e3 - this.$W) : e3;
          if (o3 === c3 || o3 === h4) {
            var y6 = this.clone().set(d2, 1);
            y6.$d[l5]($3), y6.init(), this.$d = y6.set(d2, Math.min(this.$D, y6.daysInMonth())).$d;
          } else l5 && this.$d[l5]($3);
          ...
          if (!this.isValid()) return n4.invalidDate || l4;
          var r3 = t3 || "YYYY-MM-DDTHH:mm:ssZ", i4 = b2.z(this), s3 = this.$H, u4 = this.$m, a3 = this.$M, o3 = n4.weekdays, c4 = n4.months, f8 = n4.meridiem, h5 = function(t4, n5, i5, s4) {
          ...
          return r3.replace(y5, function(t4, r4) {
            return r4 || function(t5) {
              switch (t5) {
                ...
                case "MMM":
                  return h5(n4.monthsShort, a3, c4, 3);
                case "MMMM":
                  return h5(c4, a3);
                case "D":
                  return e3.$D;
          ...
          var $3, y6 = this, M5 = b2.p(d3), m4 = O3(r3), v4 = (m4.utcOffset() - this.utcOffset()) * e2, g2 = this - m4, D2 = function() {
            return b2.m(y6, m4);
          };
          switch (M5) {
            case h4:
      ...
      return O3.prototype = k3, [["$ms", r2], ["$s", i3], ["$m", s2], ["$H", u3], ["$W", a2], ["$M", c3], ["$y", h4], ["$D", d2]].forEach(function(t3) {
        k3[t3[1]] = function(e3) {
          return this.$g(e3, t3[0], t3[1]);
        };
      }), O3.extend = function(t3, e3) {
        return t3.$i || (t3(e3, _, O3), t3.$i = true), O3;
    ...
    !function(r2, e2) {
      ...
      return function(r2, e2, t2) {
        ...
        t2.en.relativeTime = o2, n3.fromToBase = function(e3, n4, i4, d3, u3) {
          for (var f7, a2, s2, l4 = i4.$locale().relativeTime || o2, h4 = r2.thresholds || [{ l: "s", r: 44, d: "second" }, { l: "m", r: 89 }, { l: "mm", r: 44, d: "minute" }, { l: "h", r: 89 }, { l: "hh", r: 21, d: "hour" }, { l: "d", r: 35 }, { l: "dd", r: 25, d: "day" }, { l: "M", r: 45 }, { l: "MM", r: 10, d: "month" }, { l: "y", r: 17 }, { l: "yy", d: "year" }], m2 = h4.length, c3 = 0; c3 < m2; c3 += 1) {
            var y5 = h4[c3];
            y5.d && (f7 = d3 ? t2(e3).diff(i4, y5.d, true) : i4.diff(e3, y5.d, true));
            var p3 = (r2.rounding || Math.round)(Math.abs(f7));
            if (s2 = f7 > 0, p3 <= y5.r || !y5.r) {
              p3 <= 1 && c3 > 0 && (y5 = h4[c3 - 1]);
              var v3 = l4[y5.l];
              u3 && (p3 = u3("" + p3)), a2 = "string" == typeof v3 ? v3.replace("%d", p3) : v3(p3, n4, y5.l, s2);
              break;
            }
          }
          if (n4) return a2;
...
function _Big_() {
  function Big2(n3) {
    var x = this;
    if (!(x instanceof Big2)) return n3 === UNDEFINED ? _Big_() : new Big2(n3);
...
function parse(x, n3) {
  ...
  x.s = n3.charAt(0) == "-" ? (n3 = n3.slice(1), -1) : 1;
  ...
  if (i3 == nl) {
    ...
    x.e = e2 - i3 - 1;
    x.c = [];
    for (e2 = 0; i3 <= nl; ) x.c[e2++] = +n3.charAt(i3++);
  }
  return x;
}
...
function stringify(x, doExponential, isNonzero) {
  var e2 = x.e, s2 = x.c.join(""), n3 = s2.length;
  if (doExponential) {
...
P.cmp = function(y5) {
  var isneg, x = this, xc3 = x.c, yc3 = (y5 = new x.constructor(y5)).c, i3 = x.s, j = y5.s, k3 = x.e, l4 = y5.e;
  if (!xc3[0] || !yc3[0]) return !xc3[0] ? !yc3[0] ? 0 : -j : i3;
  if (i3 != j) return i3;
  isneg = i3 < 0;
  if (k3 != l4) return k3 > l4 ^ isneg ? 1 : -1;
  j = (k3 = xc3.length) < (l4 = yc3.length) ? k3 : l4;
  for (i3 = -1; ++i3 < j; ) {
...
P.div = function(y5) {
  var x = this, Big2 = x.constructor, a2 = x.c, b2 = (y5 = new Big2(y5)).c, k3 = x.s == y5.s ? 1 : -1, dp = Big2.DP;
  ...
  var bl, bt3, n3, cmp, ri3, bz = b2.slice(), ai2 = bl = b2.length, al = a2.length, r2 = a2.slice(0, bl), rl = r2.length, q3 = y5, qc2 = q3.c = [], qi4 = 0, p3 = dp + (q3.e = x.e - y5.e) + 1;
  q3.s = k3;
  k3 = p3 < 0 ? 0 : p3;
  bz.unshift(0);
  for (; rl++ < bl; ) r2.push(0);
...
P.minus = P.sub = function(y5) {
  var i3, j, t2, xlty, x = this, Big2 = x.constructor, a2 = x.s, b2 = (y5 = new Big2(y5)).s;
  if (a2 != b2) {
    y5.s = -b2;
    return x.plus(y5);
  }
  var xc3 = x.c.slice(), xe3 = x.e, yc3 = y5.c, ye4 = y5.e;
  if (!xc3[0] || !yc3[0]) {
    if (yc3[0]) {
      y5.s = -b2;
    } else if (xc3[0]) {
  ...
  if (a2 = xe3 - ye4) {
    ...
    j = ((xlty = xc3.length < yc3.length) ? xc3 : yc3).length;
    for (a2 = b2 = 0; b2 < j; b2++) {
      if (xc3[b2] != yc3[b2]) {
        xlty = xc3[b2] < yc3[b2];
        break;
  ...
  if ((b2 = (j = yc3.length) - (i3 = xc3.length)) > 0) for (; b2--; ) xc3[i3++] = 0;
  for (b2 = i3; j > a2; ) {
    if (xc3[--j] < yc3[j]) {
      for (i3 = j; i3 && !xc3[--i3]; ) xc3[i3] = 9;
      --xc3[i3];
      xc3[j] += 10;
    }
    xc3[j] -= yc3[j];
...
P.mod = function(y5) {
  var ygtx, x = this, Big2 = x.constructor, a2 = x.s, b2 = (y5 = new Big2(y5)).s;
  if (!y5.c[0]) {
    throw Error(DIV_BY_ZERO);
  }
  x.s = y5.s = 1;
...
P.plus = P.add = function(y5) {
  var e2, k3, t2, x = this, Big2 = x.constructor;
  y5 = new Big2(y5);
  if (x.s != y5.s) {
    y5.s = -y5.s;
    return x.minus(y5);
  }
  var xe3 = x.e, xc3 = x.c, ye4 = y5.e, yc3 = y5.c;
  if (!xc3[0] || !yc3[0]) {
    if (!yc3[0]) {
      if (xc3[0]) {
        y5 = new Big2(x);
  ...
  e2 = yc3.length;
  for (k3 = 0; e2; xc3[e2] %= 10) k3 = (xc3[--e2] = xc3[e2] + yc3[e2] + k3) / 10 | 0;
  if (k3) {
    xc3.unshift(k3);
    ++ye4;
  }
...
P.pow = function(n3) {
  var x = this, one = new x.constructor("1"), y5 = one, isneg = n3 < 0;
  if (n3 !== ~~n3 || n3 < -MAX_POWER || n3 > MAX_POWER) {
    throw Error(INVALID + "exponent");
  }
  if (isneg) n3 = -n3;
  for (; ; ) {
    if (n3 & 1) y5 = y5.times(x);
    n3 >>= 1;
    if (!n3) break;
    x = x.times(x);
  }
...
P.times = P.mul = function(y5) {
  var c3, x = this, Big2 = x.constructor, xc3 = x.c, yc3 = (y5 = new Big2(y5)).c, a2 = xc3.length, b2 = yc3.length, i3 = x.e, j = y5.e;
  y5.s = x.s == y5.s ? 1 : -1;
  if (!xc3[0] || !yc3[0]) {
    y5.c = [y5.e = 0];
    return y5;
  ...
  for (c3 = new Array(j = a2 + b2); j--; ) c3[j] = 0;
  for (i3 = b2; i3--; ) {
    b2 = 0;
    for (j = a2 + i3; j > i3; ) {
      b2 = c3[j] + yc3[i3] * xc3[j - i3 - 1] + b2;
      c3[j--] = b2 % 10;
      b2 = b2 / 10 | 0;
    }
    c3[j] = b2;
...
P.toPrecision = function(sd, rm) {
  var x = this, Big2 = x.constructor, n3 = x.c[0];
  if (sd !== UNDEFINED) {
    if (sd !== ~~sd || sd < 1 || sd > MAX_DP) {
      throw Error(INVALID + "precision");
    }
  ...
  return stringify(x, sd <= x.e || x.e <= Big2.NE || x.e >= Big2.PE, !!n3);
};
P.valueOf = function() {
  var x = this, Big2 = x.constructor;
  if (Big2.strict === true) {
...
var Us = class {
  ...
  process(e2, n3, r2 = false) {
    ...
    let P4 = x + S3 * a2 + L2 * c3 + U4 * (5 * d2) + _ * (5 * p3) + j * (5 * E3);
    x = P4 >>> 13, P4 &= 8191, P4 += g * (5 * y5) + w2 * (5 * h4) + b2 * (5 * f7) + I2 * (5 * l4) + R3 * (5 * u3), x += P4 >>> 13, P4 &= 8191;
    ...
    x = J2 >>> 13, J2 &= 8191, J2 += g * f7 + w2 * l4 + b2 * u3 + I2 * a2 + R3 * c3, x += J2 >>> 13, J2 &= 8191, x = (x << 2) + x | 0, x = x + C4 | 0, C4 = x & 8191, x = x >>> 13, P4 += x, i3[0] = C4, i3[1] = P4, i3[2] = k3, i3[3] = M3, i3[4] = D, i3[5] = z2, i3[6] = Z2, i3[7] = st2, i3[8] = W2, i3[9] = J2;
  }
  finalize() {
...
function _s(t2, e2, n3, r2, o2, i3 = 20) {
  let s2 = t2[0], c3 = t2[1], a2 = t2[2], u3 = t2[3], l4 = e2[0], f7 = e2[1], h4 = e2[2], y5 = e2[3], E3 = e2[4], p3 = e2[5], d2 = e2[6], v3 = e2[7], m2 = o2, O3 = n3[0], N = n3[1], $2 = n3[2], B3 = s2, A3 = c3, T = a2, S3 = u3, L2 = l4, U4 = f7, _ = h4, j = y5, g = E3, w2 = p3, b2 = d2, I2 = v3, R3 = m2, x = O3, C4 = N, P4 = $2;
  for (let M3 = 0; M3 < i3; M3 += 2) B3 = B3 + L2 | 0, R3 = V(R3 ^ B3, 16), g = g + R3 | 0, L2 = V(L2 ^ g, 12), B3 = B3 + L2 | 0, R3 = V(R3 ^ B3, 8), g = g + R3 | 0, L2 = V(L2 ^ g, 7), A3 = A3 + U4 | 0, x = V(x ^ A3, 16), w2 = w2 + x | 0, U4 = V(U4 ^ w2, 12), A3 = A3 + U4 | 0, x = V(x ^ A3, 8), w2 = w2 + x | 0, U4 = V(U4 ^ w2, 7), T = T + _ | 0, C4 = V(C4 ^ T, 16), b2 = b2 + C4 | 0, _ = V(_ ^ b2, 12), T = T + _ | 0, C4 = V(C4 ^ T, 8), b2 = b2 + C4 | 0, _ = V(_ ^ b2, 7), S3 = S3 + j | 0, P4 = V(P4 ^ S3, 16), I2 = I2 + P4 | 0, j = V(j ^ I2, 12), S3 = S3 + j | 0, P4 = V(P4 ^ S3, 8), I2 = I2 + P4 | 0, j = V(j ^ I2, 7), B3 = B3 + U4 | 0, P4 = V(P4 ^ B3, 16), b2 = b2 + P4 | 0, U4 = V(U4 ^ b2, 12), B3 = B3 + U4 | 0, P4 = V(P4 ^ B3, 8), b2 = b2 + P4 | 0, U4 = V(U4 ^ b2, 7), A3 = A3 + _ | 0, R3 = V(R3 ^ A3, 16), I2 = I2 + R3 | 0, _ = V(_ ^ I2, 12), A3 = A3 + _ | 0, R3 = V(R3 ^ A3, 8), I2 = I2 + R3 | 0, _ = V(_ ^ I2, 7), T = T + j | 0, x = V(x ^ T, 16), g = g + x | 0, j = V(j ^ g, 12), T = T + j | 0, x = V(x ^ T, 8), g = g + x | 0, j = V(j ^ g, 7), S3 = S3 + L2 | 0, C4 = V(C4 ^ S3, 16), w2 = w2 + C4 | 0, L2 = V(L2 ^ w2, 12), S3 = S3 + L2 | 0, C4 = V(C4 ^ S3, 8), w2 = w2 + C4 | 0, L2 = V(L2 ^ w2, 7);
  let k3 = 0;
  r2[k3++] = s2 + B3 | 0, r2[k3++] = c3 + A3 | 0, r2[k3++] = a2 + T | 0, r2[k3++] = u3 + S3 | 0, r2[k3++] = l4 + L2 | 0, r2[k3++] = f7 + U4 | 0, r2[k3++] = h4 + _ | 0, r2[k3++] = y5 + j | 0, r2[k3++] = E3 + g | 0, r2[k3++] = p3 + w2 | 0, r2[k3++] = d2 + b2 | 0, r2[k3++] = v3 + I2 | 0, r2[k3++] = m2 + R3 | 0, r2[k3++] = O3 + x | 0, r2[k3++] = N + C4 | 0, r2[k3++] = $2 + P4 | 0;
}
...
function gc(t2) {
  ...
  function f7(m2, O3) {
    ...
    for (let j = BigInt(o2 - 1); j >= Ht; j--) {
      ...
      const w2 = B3 + A3, b2 = r2(w2 * w2), I2 = B3 - A3, R3 = r2(I2 * I2), x = b2 - R3, C4 = T + S3, P4 = T - S3, k3 = r2(P4 * w2), M3 = r2(C4 * I2), D = k3 + M3, z2 = k3 - M3;
...
function Ic(t2) {
  ...
  class d2 {
    ...
    recoverPublicKey(w2) {
      ...
      const P4 = (R3 & 1) === 0 ? "02" : "03", k3 = a2.fromHex(P4 + h4(C4)), M3 = c3(C4), D = s2(-x * M3), z2 = s2(I2 * M3), Z2 = a2.BASE.multiplyAndAddUnsafe(k3, D, z2);
  ...
  function S3(g, w2, b2 = L2) {
    ...
    let { lowS: x, prehash: C4, extraEntropy: P4 } = b2;
  ...
  function j(g, w2, b2, I2 = U4) {
    ...
    const k3 = typeof R3 == "string" || St(R3), M3 = !k3 && !P4 && typeof R3 == "object" && R3 !== null && typeof R3.r == "bigint" && typeof R3.s == "bigint";
    ...
    C4 && (w2 = e2.hash(w2));
    const { r: Z2, s: st2 } = D, W2 = B3(w2), J2 = c3(st2), Be3 = s2(W2 * J2), zt2 = s2(Z2 * J2), vt = (_a = a2.BASE.multiplyAndAddUnsafe(z2, Be3, zt2)) == null ? void 0 : _a.toAffine();
...
var vi2 = class {
  constructor(e2, t2, i3) {
    this.core = e2, this.logger = t2, S2(this, "name", Tt2), S2(this, "keychain"), S2(this, "randomSessionIdentifier", jc()), S2(this, "initialized", false), S2(this, "init", async () => {
      ...
      return Vc({ type: l4, symKey: h4, message: c3, senderPublicKey: d2, encoding: o2 == null ? void 0 : o2.encoding });
      ...
      try {
        const c3 = this.getSymKey(s2), h4 = Mc({ symKey: c3, encoded: n3, encoding: o2 == null ? void 0 : o2.encoding });
...
var qn = class extends m {
  constructor(e2, t2) {
    super(e2, t2), this.relayer = e2, this.logger = t2, V2(this, "events", new import_events3.EventEmitter()), V2(this, "name", At2), V2(this, "queue", /* @__PURE__ */ new Map()), V2(this, "publishTimeout", (0, import_time2.toMiliseconds)(import_time2.ONE_MINUTE)), V2(this, "initialPublishTimeout", (0, import_time2.toMiliseconds)(import_time2.ONE_SECOND * 15)), V2(this, "needsTransportRestart", false), V2(this, "publish", async (i3, s2, n3) => {
      ...
      const a2 = (n3 == null ? void 0 : n3.ttl) || je2, c3 = Zc(n3), h4 = (n3 == null ? void 0 : n3.prompt) || false, l4 = (n3 == null ? void 0 : n3.tag) || 0, d2 = (n3 == null ? void 0 : n3.id) || getBigIntRpcId().toString(), g = { topic: i3, message: s2, opts: { ttl: a2, relay: c3, prompt: h4, tag: l4, id: d2, attestation: n3 == null ? void 0 : n3.attestation, tvf: n3 == null ? void 0 : n3.tvf } }, _ = `Failed to publish payload, please try again. id:${d2} tag:${l4}`;
      try {
        const u3 = new Promise(async (b2) => {
          ...
          const I2 = yi(new Promise((D, j) => {
            this.rpcPublish({ topic: i3, message: s2, ttl: a2, prompt: h4, tag: l4, id: d2, attestation: n3 == null ? void 0 : n3.attestation, tvf: n3 == null ? void 0 : n3.tvf }).then(D).catch((T) => {
              this.logger.warn(T, T == null ? void 0 : T.message), j(T);
            });
          }), this.initialPublishTimeout, `Failed initial publish, retrying.... id:${d2} tag:${l4}`);
          try {
            await I2, this.events.removeListener(C2.publish, x);
          } catch (D) {
            this.queue.set(d2, Ge2(Ie2({}, g), { attempt: 1 })), this.logger.warn(D, D == null ? void 0 : D.message);
          }
        });
...
var Li2 = class {
  constructor(e2, t2) {
    this.core = e2, this.logger = t2, p2(this, "name", Mt2), p2(this, "version", Kt2), p2(this, "events", new import_events3.default()), p2(this, "pairings"), p2(this, "initialized", false), p2(this, "storagePrefix", B), p2(this, "ignoredPayloadTypes", [Ft]), p2(this, "registeredMethods", []), p2(this, "init", async () => {
      ...
      this.isInitialized();
      const s2 = jc(), n3 = await this.core.crypto.setSymKey(s2), o2 = Ei(import_time2.FIVE_MINUTES), a2 = { protocol: xt2 }, c3 = { topic: n3, expiry: o2, relay: a2, active: false, methods: i3 == null ? void 0 : i3.methods }, h4 = Wc({ protocol: this.core.protocol, version: this.core.version, topic: n3, symKey: s2, relay: a2, expiryTimestamp: o2, methods: i3 == null ? void 0 : i3.methods });
...
var Ui2 = class extends M {
  constructor(e2, t2, i3) {
    super(e2, t2, i3), this.core = e2, this.logger = t2, this.store = i3, w(this, "name", Wt2), w(this, "abortController"), w(this, "isDevEnv"), w(this, "verifyUrlV3", Yt2), w(this, "storagePrefix", B), w(this, "version", Le), w(this, "publicKey"), w(this, "fetchPromise"), w(this, "init", async () => {
      ...
      if (!o2) return;
      const c3 = this.getVerifyUrl(s2 == null ? void 0 : s2.verifyUrl);
...
function _s2(t2, e2, n3, r2, o2, i3 = 20) {
  let s2 = t2[0], c3 = t2[1], a2 = t2[2], u3 = t2[3], l4 = e2[0], f7 = e2[1], h4 = e2[2], y5 = e2[3], E3 = e2[4], p3 = e2[5], d2 = e2[6], v3 = e2[7], m2 = o2, O3 = n3[0], N = n3[1], $2 = n3[2], B3 = s2, A3 = c3, T = a2, S3 = u3, L2 = l4, U4 = f7, _ = h4, j = y5, g = E3, w2 = p3, b2 = d2, I2 = v3, R3 = m2, x = O3, C4 = N, P4 = $2;
  for (let M3 = 0; M3 < i3; M3 += 2) B3 = B3 + L2 | 0, R3 = V3(R3 ^ B3, 16), g = g + R3 | 0, L2 = V3(L2 ^ g, 12), B3 = B3 + L2 | 0, R3 = V3(R3 ^ B3, 8), g = g + R3 | 0, L2 = V3(L2 ^ g, 7), A3 = A3 + U4 | 0, x = V3(x ^ A3, 16), w2 = w2 + x | 0, U4 = V3(U4 ^ w2, 12), A3 = A3 + U4 | 0, x = V3(x ^ A3, 8), w2 = w2 + x | 0, U4 = V3(U4 ^ w2, 7), T = T + _ | 0, C4 = V3(C4 ^ T, 16), b2 = b2 + C4 | 0, _ = V3(_ ^ b2, 12), T = T + _ | 0, C4 = V3(C4 ^ T, 8), b2 = b2 + C4 | 0, _ = V3(_ ^ b2, 7), S3 = S3 + j | 0, P4 = V3(P4 ^ S3, 16), I2 = I2 + P4 | 0, j = V3(j ^ I2, 12), S3 = S3 + j | 0, P4 = V3(P4 ^ S3, 8), I2 = I2 + P4 | 0, j = V3(j ^ I2, 7), B3 = B3 + U4 | 0, P4 = V3(P4 ^ B3, 16), b2 = b2 + P4 | 0, U4 = V3(U4 ^ b2, 12), B3 = B3 + U4 | 0, P4 = V3(P4 ^ B3, 8), b2 = b2 + P4 | 0, U4 = V3(U4 ^ b2, 7), A3 = A3 + _ | 0, R3 = V3(R3 ^ A3, 16), I2 = I2 + R3 | 0, _ = V3(_ ^ I2, 12), A3 = A3 + _ | 0, R3 = V3(R3 ^ A3, 8), I2 = I2 + R3 | 0, _ = V3(_ ^ I2, 7), T = T + j | 0, x = V3(x ^ T, 16), g = g + x | 0, j = V3(j ^ g, 12), T = T + j | 0, x = V3(x ^ T, 8), g = g + x | 0, j = V3(j ^ g, 7), S3 = S3 + L2 | 0, C4 = V3(C4 ^ S3, 16), w2 = w2 + C4 | 0, L2 = V3(L2 ^ w2, 12), S3 = S3 + L2 | 0, C4 = V3(C4 ^ S3, 8), w2 = w2 + C4 | 0, L2 = V3(L2 ^ w2, 7);
  let k3 = 0;
  r2[k3++] = s2 + B3 | 0, r2[k3++] = c3 + A3 | 0, r2[k3++] = a2 + T | 0, r2[k3++] = u3 + S3 | 0, r2[k3++] = l4 + L2 | 0, r2[k3++] = f7 + U4 | 0, r2[k3++] = h4 + _ | 0, r2[k3++] = y5 + j | 0, r2[k3++] = E3 + g | 0, r2[k3++] = p3 + w2 | 0, r2[k3++] = d2 + b2 | 0, r2[k3++] = v3 + I2 | 0, r2[k3++] = m2 + R3 | 0, r2[k3++] = O3 + x | 0, r2[k3++] = N + C4 | 0, r2[k3++] = $2 + P4 | 0;
}
...
function Ic2(t2) {
  ...
  function j(g, w2, b2, I2 = U4) {
    ...
    if (P4 !== void 0 && P4 !== "compact" && P4 !== "der") throw new Error("format must be compact or der");
    const k3 = typeof R3 == "string" || St3(R3), M3 = !k3 && !P4 && typeof R3 == "object" && R3 !== null && typeof R3.r == "bigint" && typeof R3.s == "bigint";
    if (!k3 && !M3) throw new Error("invalid signature, expected Uint8Array, hex string or Signature instance");
    let D, z2;
    try {
      if (M3 && (D = new d2(R3.r, R3.s)), k3) {
...
@walletconnect/utils/dist/index.es.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-DKGBJT4B.js.map
